 ...
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA ParseInc. (http://www.zend.com)
...
class Zend_Validate_Between extends Zend_Validate_Abstract
{
     ...
     * @return boolean
     */
    public function getParseInclusive()
    {
     ...
     * @return Zend_Validate_Between Provides a fluent interface
     */
    public function setParseInclusive($inclusive)
    {
